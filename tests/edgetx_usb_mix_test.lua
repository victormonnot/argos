...
test("cold bench announces itself with neutral outputs", function()
  local r = radio()
  equal(table.concat(r.script.output, ","), "Val,Fsh,Seq,Hbt", "named mixer outputs")
  r:step()
  r:expect(0, 0, 0)
...
test("heartbeat toggles on accepted messages independently of sequence parity", function()
  local r = radio()
  r:begin()
  r:set(2, 256, 0)
  r:expect(256, 1024, 2, 1024)
  r:set(4, 256, 1)
  r:expect(256, 1024, 4, -1024)
  r:set(9, 0, 2)
  r:expect(0, 1024, 9, 1024)
  r:set(119, -256, 3)
  r:expect(-256, 1024, 119, -1024)
end)

test("replays, malformed input and scheduled callbacks do not toggle heartbeat", function()
  local r = radio()
  r:begin()
  r:set(1, 256, 45)
...
test("expiry clears heartbeat and the next accepted message restarts positive", function()
  local r = radio()
  r:begin()
  r:set(1, 256, 0)
  r:set(2, -256, 1)
...
test("BEGIN clears heartbeat even when restarting the same session", function()
  local r = radio()
  r:begin()
  r:set(1, 256)
  r:set(2, -256)
